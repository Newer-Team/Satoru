# NSIS Installer Script for Satoru
# 
# Change the values below to change basic settings:
!define Name "Satoru"
!define InputDir "distrib\satoru"
!define OutputName "satoru.exe"
!define Publisher "RHCafe"
!define IconPath "satorudata\win_icon.ico"
...
Function CreateDesktopShortcut
	CreateShortCut "$DESKTOP\${Name}.lnk" "$INSTDIR\satoru.exe"
FunctionEnd

Function CreateStartMenuShortcut
	CreateShortCut "$SMPROGRAMS\${Name}.lnk" "$INSTDIR\satoru.exe"
FunctionEnd
...
Section
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${Name}" \
				"URLInfoAbout"    "http://rhcafe.us.to"
